...
- If you feel decent on multiple choice but really need coding practice, try some FRQ practice instead. For each of the below bullets, I'm linking to the first FRQ on Runestone for each type. **If you move to the next page, there are more FRQ of each type.** Remember that Runestone is a textbook and every page has arrow buttons to the left and right that let you move page to page.
